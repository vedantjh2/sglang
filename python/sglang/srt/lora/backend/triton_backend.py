...
class TritonLoRABackend(BaseLoRABackend):
    ...
    def init_cuda_graph_batch_info(
        ...
        with torch.device("cuda"):
            self.cuda_graph_batch_info = LoRABatchInfo(
                ...
                # It must be large enough for the max token count.
            ...
            self.cuda_graph_batch_info.seg_lens[:max_bs_in_cuda_graph].fill_(1)
            torch.cumsum(
    ...
    def prepare_lora_batch(
        ...
        if use_cuda_graph:
            ...
            # Do NOT update batch_info.bs: it controls the kernel grid size
            # and is baked into the CUDA graph at capture time.
            ...
            if forward_batch.forward_mode.is_extend():
                ...
                # Zero stale entries so extra grid blocks (batch_id >= bs)
                # see seg_len=0 and exit early, preventing them from
                # processing garbage data at stale seg_indptr offsets.
